...
function getProductsById() {
    ...
    var row = '<tr>' +
        '<th scope="col" style="text-align:left;">Client SKU</th>' +
        '<th scope="col" style="text-align:left;">Product Name</th>' +
        '<th scope="col" style="text-align:left;">BrandId</th>' +
